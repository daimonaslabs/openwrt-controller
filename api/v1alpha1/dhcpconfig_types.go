...
type DnsmasqSection struct {
	...
	// return NXDOMAIN).
	BogusNXDOMAIN []ubus.IP `json:"bogusNXDOMAIN,omitempty" ubus:"bogusnxdomain,omitempty"`
	...
	ListenAddress []ubus.IP `json:"listenAddress,omitempty" ubus:"listen_address,omitempty"`
